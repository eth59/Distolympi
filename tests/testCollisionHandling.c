...
void test_openCollisionFile() {
    ...
    TEST_ASSERT_EQUAL_STRING("11111112111111111000010000000001101000000100010120000000000000022000000000000002100000000000001111000000100000011111111111112111", output1);
    free(output1);

    char *filename2 = "assets/map02.txt";
    char *output2 = openCollisionFile(filename2);
    TEST_ASSERT_NOT_NULL(output2);
    TEST_ASSERT_EQUAL_STRING("11112111111111111000000000010011110100000100000120000000000000022000000000000002100000000010000110011000000000011111111211112111", output2);
    free(output2);
}
