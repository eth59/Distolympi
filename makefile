...
SRC = main.c $(FILES) 
SRC_TEST = tests/test.c $(FILES) tests/testInventory.c tests/testObjects.c tests/testCollisionHandling.c tests/testSelectRandomMap.c tests/testAnimations.c tests/testCharacter.c
